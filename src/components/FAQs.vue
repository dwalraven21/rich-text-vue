<template>
    <main>
        ...
        <!-- The rest of the content for your page goes here -->
...
export default {
  ...
  data(){
        return {
          // I used google's guide for how to format my json-ld: https://developers.google.com/search/docs/data-types/faqpage
            jsonld: {
